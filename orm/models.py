...
from sqlalchemy import Column, DateTime, ForeignKeyConstraint, Integer, Numeric, PrimaryKeyConstraint, Sequence, SmallInteger, String, Text
...
class Customer(Base):
    ...
    orderss: Mapped[List['Order']] = relationship('Order', back_populates='customer')
...
class Employee(Base):
    ...
    orderss: Mapped[List['Order']] = relationship('Order', back_populates='employee')
...
class Product(Base):
    ...
    order_detailss: Mapped[List['OrderDetail']] = relationship('OrderDetail', back_populates='product')
...
class Order(Base):
    ...
    customer: Mapped['Customer'] = relationship('Customer', back_populates='orderss')
    employee: Mapped['Employee'] = relationship('Employee', back_populates='orderss')
    order_detailss: Mapped[List['OrderDetail']] = relationship('OrderDetail', back_populates='order')
...
class OrderDetail(Base):
    ...
    order: Mapped['Order'] = relationship('Order', back_populates='order_detailss')
    product: Mapped['Product'] = relationship('Product', back_populates='order_detailss')
